...
class Worker:
    def __init__(self, name, surname, position, income):
        ...
        self._incone_bonus = income['bonus']


class Position(Worker):

    def get_full_name(self):
        return f'{self.name} {self.surmane} {self.position}'
...
sport_car = SportCar(240, 'Синия', 'Спортивная машина', False)
town_car = TownCar(140, 'Белая', 'Городская машина', False)
work_car = WorkCar(90, 'Желтая', 'Рабочая машина', False)
police_car = PoliceCar(210, 'Черная', 'Полицейская машина', False)
